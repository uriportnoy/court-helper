        ...
        <div className="flex items-center gap-2 border-l pl-4">
          ...
          <button
            onClick={() =>
              onSettingsChange({
                ...pdfSettings,
                showTable: !pdfSettings.showTable,
              })
            }
          ...
          <button
            onClick={() =>
              onSettingsChange({
                ...pdfSettings,
                showDeclaration: !pdfSettings.showDeclaration,
              })
            }
            className={`inline-flex items-center px-3 py-2 rounded-md text-sm font-medium transition-all
              ${
          ...
          <button
            onClick={() =>
              onSettingsChange({
                ...pdfSettings,
                showPages: !pdfSettings.showPages,
              })
            }
            className={`inline-flex items-center px-3 py-2 rounded-md text-sm font-medium transition-all
              ${
            ...
            title={
              pdfSettings.showPages ? "הסתר עמודי נספחים" : "הצג עמודי נספחים"
            }
          >
